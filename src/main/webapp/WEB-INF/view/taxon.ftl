...
<#assign page={"title": data.pageTitle+ " - " + rc.getMessage("site_title"), "cssList": [rc.getContextUrl("/styles/vascan.css")], "cssListPrint": [rc.getContextUrl("/styles/print.css")], "javaScriptIncludeList": 
