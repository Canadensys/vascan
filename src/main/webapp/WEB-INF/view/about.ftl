...
<p>For every species, subspecies and variety in VASCAN we provide the accepted <strong>scientific name</strong> (Latin), the accepted French and English <strong>vernacular name</strong>, and their <strong>synonyms/alternatives</strong> in Canada. We indicate the <strong>distribution</strong> status (<a href="#distribution">native, introduced, etc.</a>) of the plant for each province or territory, and the <strong>habit</strong> (tree, shrub, herb or vine) of the plant in Canada. For reported hybrids (nothotaxa or hybrid formulas), we also provide the <strong>hybrid parents</strong>, except for introduced hybrids. We refer to a <strong>source</strong> for all name, classification and distribution information.</p>
<p>All taxa are linked to a classification. We follow the <a href="https://doi.org/10.1111/jse.12229">Pteridophyte Phylogeny Group (2016)</a> for lycophytes and monilophytes (ferns and allies), <a href="http://www.mapress.com/phytotaxa/content/2011/f/pt00019p070.pdf">Christenhusz et al. (2011b)</a> for gymnosperms, <a href="http://dx.doi.org/10.1111/j.1095-8339.2009.00996.x">APG III (2009)</a> for flowering plants and <a href="http://dx.doi.org/10.1111/j.1095-8339.2009.01002.x">Chase and Reveal (2009)</a> for the higher taxonomy. We do not provide core information (synonyms, vernacular names, etc.) for most higher taxa (above species), but we do calculate a distribution<a href="#remark">*</a> and habit based on lower taxa.</p>
...
<ul class="custom_list">
	...
	<li class="sprite sprite-ephemeral"><strong>Ephemeral</strong> - Taxon not established permanently in the region, but recurring in the wild on a near-annual basis, usually from cultivation (e.g. <a href="${rc.getContextUrl("/name/wheat")}">wheat</a>, <a href="${rc.getContextUrl("/name/tomato")}">tomato</a>, etc.).</li>
...
<ul class="index">
	<li><a href="#introduction">Introduction</a></li>
	<li><a href="#rationale">Objectifs</a></li>
	<li><a href="#people">Personnes</a></li>
	<li><a href="#rights">Citation, droits et avis de non-responsabilité</a></li>
	<li><a href="#feedback">Commentaires</a></li>
	<li><a href="#distribution">Légende des états de répartition</a></li>
</ul>
<a name="introduction"></a><h2>Introduction</h2>
...
<ul class="custom_list">
	...
	<li class="sprite sprite-ephemeral"><strong>Éphémère</strong> - Taxon non établi de façon permanente dans une région, mais présent de manière récurrente dans la nature, quasi annuellement, généralement à partir de cultures (<a href="${rc.getContextUrl("/name/blé")}">blé</a>, <a href="${rc.getContextUrl("name/tomate")}">tomate</a>, etc.).</li>
